...
!(function (t, e) {
        ...
        if (i < 128) e += s[i];
          ...
          if (240 == (248 & i) && r + 9 < n) {
            ...
            if (128 == (192 & n) && 128 == (192 & s) && 128 == (192 & o)) {
              ...
              t < 65536 || t > 1114111 ? (e += '\ufffd\ufffd\ufffd\ufffd') : ((t -= 65536), (e += String.fromCharCode(55296 + (t >> 10), 56320 + (1023 & t)))),
                (r += 9);
              continue;
            }
          }
  ...
  (i.prototype.parse = function (t, e) {
    ...
    if (
      ...
      (e || u || i.match(/^\/\/[^@\/]+@[^@\/]+/)) && ((s = '//' === i.substr(0, 2)), !s || (u && _[u]) || ((i = i.substr(2)), (this.slashes = !0))),
      !_[u] && (s || (u && !m[u])))
    ) {
      let t,
        e,
    ...
    z =
      null !== (k = String.fromCodePoint) && void 0 !== k
        ...
        : function (t) {
            let e = '';
            return (
              t > 65535 && ((t -= 65536), (e += String.fromCharCode(((t >>> 10) & 1023) | 55296)), (t = 56320 | (1023 & t))), (e += String.fromCharCode(t)), e
            );
          };
  var S;
  !(function (t) {
  ...
  class R {
    ...
    emitNumericEntity(t, e) {
      ...
      return (
        ...
        this.errors && (t !== S.SEMI && this.errors.missingSemicolonAfterCharacterReference(), this.errors.validateNumericCharacterReference(this.result)),
        this.consumed
      );
    }
    stateNamedEntity(t, e) {
      ...
      for (; e < t.length; e++, this.excess++) {
        ...
        if (((this.treeIndex = P(r, n, this.treeIndex + Math.max(1, s), i)), this.treeIndex < 0))
          return 0 === this.result || (this.decodeMode === L.Attribute && (0 === s || T(i))) ? 0 : this.emitNotTerminatedNamedEntity();
    ...
    emitNotTerminatedNamedEntity() {
      ...
      return (
        this.emitNamedEntityData(e, n, this.consumed), null === (t = this.errors) || void 0 === t || t.missingSemicolonAfterCharacterReference(), this.consumed
      );
    }
  ...
  function xt(t) {
    ...
    for (let r = t.length - 1; r >= 0; r--) {
      const n = t[r];
      'text' !== n.type || e || (n.content = n.content.replace(bt, Ft)),
    ...
    for (let s = 0; s < t.length; s++) {
      ...
      t: for (; c < a; ) {
        ...
        if (
          ...
          if (p)
            for (r = n.length - 1; r >= 0; r--) {
              ...
              if (h.single === f && n[r].level === o) {
                let o, p;
                (h = n[r]),
                  f ? ((o = e.md.options.quotes[2]), (p = e.md.options.quotes[3])) : ((o = e.md.options.quotes[0]), (p = e.md.options.quotes[1])),
          ...
          h ? n.push({ token: s, pos: l.index, single: f, level: o }) : p && f && (i.content = St(i.content, l.index, '\u2019'));
        } else f && (i.content = St(i.content, l.index, '\u2019'));
      }
    }
  }
  const Bt = [
    ...
    [
      ...
      function (t) {
        ...
        if (t.md.options.linkify)
          for (let r = 0, n = e.length; r < n; r++) {
            if ('inline' !== e[r].type || !t.md.linkify.pretest(e[r].content)) continue;
            let n = e[r].children,
              s = 0;
            for (let i = n.length - 1; i >= 0; i--) {
              const o = n[i];
              if ('link_close' !== o.type) {
                if (
                  ('html_inline' === o.type && (Dt(o.content) && s > 0 && s--, Ct(o.content) && s++),
                  !(s > 0) && 'text' === o.type && t.md.linkify.test(o.content))
                ) {
                  const s = o.content;
                  let u = t.md.linkify.match(s);
                  const c = [];
                  let a = o.level,
                    l = 0;
                  u.length > 0 && 0 === u[0].index && i > 0 && 'text_special' === n[i - 1].type && (u = u.slice(1));
                  for (let e = 0; e < u.length; e++) {
                    const r = u[e].url,
                      n = t.md.normalizeLink(r);
                    if (!t.md.validateLink(n)) continue;
                    let i = u[e].text;
                    i = u[e].schema
                      ? 'mailto:' !== u[e].schema || /^mailto:/i.test(i)
                        ? t.md.normalizeLinkText(i)
                        : t.md.normalizeLinkText('mailto:' + i).replace(/^mailto:/, '')
                      : t.md.normalizeLinkText('http://' + i).replace(/^http:\/\//, '');
                    const o = u[e].index;
                    if (o > l) {
                      const e = new t.Token('text', '', 0);
                      (e.content = s.slice(l, o)), (e.level = a), c.push(e);
                    }
                    const h = new t.Token('link_open', 'a', 1);
                    (h.attrs = [['href', n]]), (h.level = a++), (h.markup = 'linkify'), (h.info = 'auto'), c.push(h);
                    const p = new t.Token('text', '', 0);
                    (p.content = i), (p.level = a), c.push(p);
                    const f = new t.Token('link_close', 'a', -1);
                    (f.level = --a), (f.markup = 'linkify'), (f.info = 'auto'), c.push(f), (l = u[e].lastIndex);
                  }
                  if (l < s.length) {
                    const e = new t.Token('text', '', 0);
                    (e.content = s.slice(l)), (e.level = a), c.push(e);
                  }
                  e[r].children = n = H(n, i, c);
                }
              } else for (i--; n[i].level !== o.level && 'link_open' !== n[i].type; ) i--;
            }
          }
      }
    ],
        ...
        if (t.md.options.typographer)
          for (e = t.tokens.length - 1; e >= 0; e--)
            'inline' === t.tokens[e].type &&
              (Et.test(t.tokens[e].content) && xt(t.tokens[e].children), yt.test(t.tokens[e].content) && wt(t.tokens[e].children));
      }
    ],
    [
      'smartquotes',
      function (t) {
        if (t.md.options.typographer)
          for (let e = t.tokens.length - 1; e >= 0; e--) 'inline' === t.tokens[e].type && vt.test(t.tokens[e].content) && qt(t.tokens[e].children, t);
      }
    ],
    [
      'text_join',
  ...
  function Tt(t) {
    ...
    let n = 0,
      ...
      u = '';
    for (; n < r; )
      124 === s && (i ? ((u += t.substring(o, n - 1)), (o = n)) : (e.push(u + t.substring(o, n)), (u = ''), (o = n + 1))),
        (i = 92 === s),
        n++,
        (s = t.charCodeAt(n));
  ...
  const Pt = '<[A-Za-z][A-Za-z0-9\\-]*(?:\\s+[a-zA-Z_:][a-zA-Z0-9:._-]*(?:\\s*=\\s*(?:[^"\'=<>`\\x00-\\x20]+|\'[^\']*\'|"[^"]*"))?)*\\s*\\/?>',
    ...
    jt = new RegExp(
      '^(?:' + Pt + '|' + Ot + '|\x3c!---?>|\x3c!--(?:[^-]|-[^-]|--[^>])*--\x3e|<[?][\\s\\S]*?[?]>|<![A-Za-z][^>]*>|<!\\[CDATA\\[[\\s\\S]*?\\]\\]>)'
    ),
    Zt = new RegExp('^(?:' + Pt + '|' + Ot + ')'),
    $t = [
  ...
  const Ut = [
    ...
    [
      ...
      function (t, e, r, n) {
        ...
        let h = e,
          p = !1;
        for (; (h++, !(h >= r)) && ((s = u = t.bMarks[h] + t.tShift[h]), (i = t.eMarks[h]), !(s < i && t.sCount[h] < t.blkIndent)); )
    ...
    [
      ...
      function (t, e, r, n) {
        ...
        for (f = e; f < r; f++) {
          ...
          if (n) {
            (t.lineMax = f),
              0 !== t.blkIndent && (u.push(t.bMarks[f]), c.push(t.bsCount[f]), l.push(t.tShift[f]), a.push(t.sCount[f]), (t.sCount[f] -= t.blkIndent));
            break;
          }
          ...
          a &&
            (function (t, e) {
              ...
              for (let n = e + 2, s = t.tokens.length - 2; n < s; n++)
                t.tokens[n].level === r && 'paragraph_open' === t.tokens[n].type && ((t.tokens[n + 2].hidden = !0), (t.tokens[n].hidden = !0), (n += 2));
            })(t, _),
          !0
        );
      },
  ...
  (Ht.prototype.tokenize = function (t, e, r) {
    ...
    (Vt.prototype.push = function (t, e, r) {
      ...
      return (
        ...
        (n.level = this.level),
        r > 0 && (this.level++, this._prev_delimiters.push(this.delimiters), (this.delimiters = []), (s = { delimiters: this.delimiters })),
  ...
  var Xt = {
    tokenize: function (t, e) {
      ...
      for (let e = 0; e < i; e += 2)
        (u = t.push('text', '', 0)),
          (u.content = o + o),
          t.delimiters.push({ marker: n, length: 0, token: t.tokens.length - 1, end: -1, open: s.can_open, close: s.can_close });
    ...
    tokenize: function (t, e) {
      ...
      for (let e = 0; e < s.length; e++) {
        (t.push('text', '', 0).content = String.fromCharCode(n)),
          t.delimiters.push({ marker: n, length: s.length, token: t.tokens.length - 1, end: -1, open: s.can_open, close: s.can_close });
      }
      return (t.pos += s.length), !0;
    },
    postProcess: function (t) {
  ...
  const ie = [
      ...
      [
        ...
        function (t, e) {
          ...
          let u = o.length;
          for (; u > 0 && 42 === o.charCodeAt(u - 1); ) u--;
          u !== o.length && (o = o.slice(0, u));
          const c = t.md.normalizeLink(o);
          ...
          if (a) {
            ...
            if (
              (d < h && 91 === t.src.charCodeAt(d)
                ? ((c = d + 1), (d = t.md.helpers.parseLinkLabel(t, d)), d >= 0 ? (n = t.src.slice(c, d++)) : (d = f + 1))
                : (d = f + 1),
              n || (n = t.src.slice(p, f)),
          ...
          if (((i = d + 1), i < p && 40 === t.src.charCodeAt(i))) {
            ...
            if (
              (i < p && 91 === t.src.charCodeAt(i)
                ? ((a = i + 1), (i = t.md.helpers.parseLinkLabel(t, i)), i >= 0 ? (s = t.src.slice(a, i++)) : (i = d + 1))
                : (i = d + 1),
              s || (s = t.src.slice(f, d)),
  ...
  const fe = {
    ...
    de = 'biz|com|edu|gov|net|org|pro|web|xxx|aero|asia|coop|info|museum|name|shop|\u0440\u0444'.split('|');
  function _e(t) {
    const e = (t.re = (function (t) {
        ...
        return (
          ...
          (e.src_host_terminator = '(?=$|[><\uff5c]|' + e.src_ZPCc + ')(?!' + (t['---'] ? '-(?!--)|' : '-|') + '_|:\\d|\\.-|\\.(?!$|' + e.src_ZPCc + '))'),
          (e.src_path =
            '(?:[/?#](?:(?!' +
            e.src_ZCc +
            '|' +
  ...
  (ke.prototype.add = function (t, e) {
    return (this.__schemas__[t] = e), _e(this), this;
  }),
      ...
      return (
        this.__opts__.fuzzyLink &&
          ...
          c >= 0 &&
            ...
            (this.__index__ < 0 || i < this.__index__) && ((this.__schema__ = ''), (this.__index__ = i), (this.__last_index__ = r.index + r[0].length)))),
    ...
    (ke.prototype.testSchemaAt = function (t, e, r) {
      return this.__compiled__[e.toLowerCase()] ? this.__compiled__[e.toLowerCase()].validate(t, r, this) : 0;
    }),
    (ke.prototype.match = function (t) {
      const e = [];
      let r = 0;
      this.__index__ >= 0 && this.__text_cache__ === t && (e.push(ge(this, r)), (r = this.__last_index__));
      let n = r ? t.slice(r) : t;
      for (; this.test(n); ) e.push(ge(this, r)), (n = n.slice(this.__last_index__)), (r += this.__last_index__);
    ...
    (ke.prototype.matchAtStart = function (t) {
      ...
      return r ? ((this.__schema__ = e[2]), (this.__index__ = e.index + e[1].length), (this.__last_index__ = e.index + e[0].length + r), ge(this, 0)) : null;
    }),
    (ke.prototype.tlds = function (t, e) {
      return (
        ...
        e
          ? ((this.__tlds__ = this.__tlds__
            ...
            _e(this),
            this)
          : ((this.__tlds__ = t.slice()), (this.__tlds_replaced__ = !0), _e(this), this)
      );
    }),
  ...
  const Se = function (t) {
      return t >= 48 && t < 58 ? t - 48 + 26 : t >= 65 && t < 91 ? t - 65 : t >= 97 && t < 123 ? t - 97 : Ce;
    },
    qe = function (t, e) {
    ...
    Be = function (t, e, r) {
      let n = 0;
      for (t = r ? Fe(t / 700) : t >> 1, t += Fe(t / e); t > 455; n += Ce) t = Fe(t / 35);
      return Fe(n + (36 * t) / (t + 38));
    },
    Le = function (t) {
      const e = [],
        r = t.length;
      let n = 0,
        ...
        o = t.lastIndexOf('-');
      o < 0 && (o = 0);
      for (let r = 0; r < o; ++r) t.charCodeAt(r) >= 128 && we('not-basic'), e.push(t.charCodeAt(r));
      for (let u = o > 0 ? o + 1 : 0; u < r; ) {
        const o = n;
        for (let e = 1, s = Ce; ; s += Ce) {
          u >= r && we('invalid-input');
          const o = Se(t.charCodeAt(u++));
          o >= Ce && we('invalid-input'), o > Fe((De - n) / e) && we('overflow'), (n += o * e);
          const c = s <= i ? 1 : s >= i + 26 ? 26 : s - i;
          if (o < c) break;
          const a = Ce - c;
          e > Fe(De / a) && we('overflow'), (e *= a);
        }
        const c = e.length + 1;
        (i = Be(n - o, c, 0 == o)), Fe(n / c) > De - s && we('overflow'), (s += Fe(n / c)), (n %= c), e.splice(n++, 0, s);
      }
    ...
    Ie = function (t) {
      ...
      let n = 128,
        s = 0,
        i = 72;
      for (const r of t) r < 128 && e.push(xe(r));
      const o = e.length;
      let u = o;
      for (o && e.push('-'); u < r; ) {
        let r = De;
        ...
        const c = u + 1;
        r - n > Fe((De - s) / c) && we('overflow'), (s += (r - n) * c), (n = r);
        for (const r of t)
          if ((r < n && ++s > De && we('overflow'), r === n)) {
            let t = s;
            for (let r = Ce; ; r += Ce) {
              ...
              const s = t - n,
                o = Ce - n;
              e.push(xe(qe(n + (s % o), 0))), (t = Fe(s / o));
            }
            e.push(xe(qe(t, 0))), (i = Be(s, c, u === o)), (s = 0), ++u;
          }
        ++s, ++n;
      }
      return e.join('');
    ...
    Me = function (t) {
      return ve(t, function (t) {
        return Ee.test(t) ? 'xn--' + Ie(t) : t;
      });
    },
    Te = function (t) {
      return ve(t, function (t) {
        return ye.test(t) ? Le(t.slice(4).toLowerCase()) : t;
      });
    };
  const Re = {
      default: {
    ...
    Ne = /^(vbscript|javascript|file|data):/,
    Pe = /^data:image\/(gif|png|jpeg|webp);/;
  function Oe(t) {
  ...
  function Ze(t) {
    ...
    if (e.hostname && (!e.protocol || je.indexOf(e.protocol) >= 0))
      try {
        e.hostname = Me(e.hostname);
      } catch (t) {}
    return n(s(e));
  }
  function $e(t) {
    const r = g(t, !0);
    if (r.hostname && (!r.protocol || je.indexOf(r.protocol) >= 0))
      try {
        r.hostname = Te(r.hostname);
      } catch (t) {}
  ...
  return (
    ...
    (Ue.prototype.configure = function (t) {
      ...
      if (Z(t)) {
        const e = t;
        if (!(t = Re[e])) throw new Error('Wrong `markdown-it` preset "' + e + '", check name');
      }
