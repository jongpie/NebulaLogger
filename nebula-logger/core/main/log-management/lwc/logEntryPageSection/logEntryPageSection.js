...
import EXCEPTION_LOCATION_FIELD from '@salesforce/schema/LogEntry__c.ExceptionLocation__c';
...
const SECTION_FIELD_SETS = {
  Message: [MESSAGE_FIELD, STACK_TRACE_FIELD],
  Exception: [EXCEPTION_MESSAGE_FIELD, EXCEPTION_TYPE_FIELD, EXCEPTION_STACK_TRACE_FIELD, EXCEPTION_LOCATION_FIELD],
  'HTTP Request': [HTTP_REQUEST_METHOD_FIELD, HTTP_REQUEST_ENDPOINT_ADDRESS_FIELD, HTTP_REQUEST_HEADERS_FIELD, HTTP_REQUEST_BODY_FIELD],
  'HTTP Response': [HTTP_RESPONSE_STATUS_CODE_FIELD, HTTP_RESPONSE_HEADERS_FIELD, HTTP_RESPONSE_BODY_FIELD],
  'Related Record Details': [RELATED_RECORD_ID_FIELD, RELATED_RECORD_JSON_FIELD, RELATED_RECORD_NAME_FIELD]
};

// Define which fields should use loggerCodeViewer and their language
const CODE_VIEWER_FIELDS = {
  ExceptionMessage__c: 'text',
  ExceptionStackTrace__c: 'text',
  HttpRequestBody__c: 'json',
  HttpRequestHeaders__c: 'json',
  HttpResponseBody__c: 'json',
  HttpResponseHeaders__c: 'json',
  Message__c: 'text',
  StackTrace__c: 'text'
};
