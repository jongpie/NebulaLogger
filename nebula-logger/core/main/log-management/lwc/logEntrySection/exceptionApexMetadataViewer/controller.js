...
const ExceptionApexMetadataViewer = class {
    logEntryContext;
    mockJavaScript;
    ...
    setupParentController(parentController) {
        ...
        console.log('ExceptionApexMetadataViewer now has this.logEntry', this.logEntry);
        this.logEntryContext = parentController.logEntryContext;
        console.log('ExceptionApexMetadataViewer now has this.logEntryContext', this.logEntryContext);
        ...
        // console.log('setting up Prism, i guess', Prism);
        this.highlight();
...
export function getDelegateController(parentController) {
    ...
    console.log('running ExceptionApexMetadataViewer.getDelegateController()', parentController);
    const controller = new ExceptionApexMetadataViewer();
