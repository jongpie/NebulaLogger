...
export default class LoggerCodeViewer extends LightningElement {
  ...
  async _loadPrismResources() {
    const prismStyleUrl = loggerStaticResources + '/prism.css';
    const prismScriptUrl = loggerStaticResources + '/prism.js';
    const resourceLoads = [
      { resourceType: 'style', resourceUrl: prismStyleUrl, promise: loadStyle(this, prismStyleUrl) },
