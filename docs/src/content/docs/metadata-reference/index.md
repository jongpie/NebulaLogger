...
description: >-
  Auto-generated metadata reference for Nebula Logger Apex classes, custom
  objects, triggers, and LWCs.
---
...
- **custom-objects** - `Log__c`, `LogEntry__c`, `LogEntryEvent__e`, and every custom metadata type Nebula Logger ships. Includes every field with full metadata (length, required, formulas, picklist values, security classification, and more).
