...
function Get-Released-Versions {
    $releasedPackageVersions = (npx sf package version list --packages "Nebula Logger - Core" --released --order-by "MajorVersion DESC, MinorVersion DESC, PatchVersion DESC" --json | ConvertFrom-Json).result
