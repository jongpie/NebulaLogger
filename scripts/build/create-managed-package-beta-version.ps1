...
npx sfdx force:package:version:create --json --package "Nebula Logger - Managed Package" --codecoverage --installationkeybypass --wait 60 --branch $gitBranch --tag $gitCommit
